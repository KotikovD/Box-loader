...
public partial class GameContext {
    ...
    public GameEntity SetSceneService(ISceneService newValue) {
        if (hasSceneService) {
    ...
    public void ReplaceSceneService(ISceneService newValue) {
...
public partial class GameEntity {
    ...
    public void AddSceneService(ISceneService newValue) {
